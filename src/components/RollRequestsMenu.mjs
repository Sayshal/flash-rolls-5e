...
import { RollMenuEventUtil } from './utils/RollMenuEventUtil.mjs';
...
export default class RollRequestsMenu extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  _onRender(context, options) {
    ...
    RollMenuEventUtil.attachListeners(this, this.element);
  }
  ...
  async _onToggleRollRequests(event) {
    return RollMenuStateUtil.handleToggleRollRequests(event);
  }
  ...
  async _onToggleSkipDialogs(event) {
    return RollMenuStateUtil.handleToggleSkipDialogs(event);
  }
  ...
  async _onToggleGroupRollsMsg(event) {
    return RollMenuStateUtil.handleToggleGroupRollsMsg(event);
  }
   ...
   */
  _onToggleLock(event) {
    return RollMenuStateUtil.handleToggleLock(event, this);
  }
  ...
  _updateRequestTypesVisibility() {
    return RollMenuStateUtil.updateRequestTypesVisibility(this);
  }
  ...
  _updateRequestTypesVisibilityNoRender() {
    return RollMenuStateUtil.updateRequestTypesVisibilityNoRender(this);
  }
  ...
  _updateSelectAllState() {
    return RollMenuStateUtil.updateSelectAllState(this);
  }
  ...
  async _orchestrateRollsForActors(config, pcActors, npcActors, rollMethodName, rollKey, actorsData) {
    return RollMenuOrchestrationUtil.orchestrateRollsForActors(config, pcActors, npcActors, rollMethodName, rollKey, actorsData, this);
  }
  ...
  async _handleHitDieRefill(actorsToRefill) {
    return RollMenuOrchestrationUtil.handleHitDieRefill(actorsToRefill);
  }
  ...
  async _triggerRoll(requestType, rollKey) {
    return RollMenuOrchestrationUtil.triggerRoll(requestType, rollKey, this);
  }
  ...
  async _sendRollRequestToPlayer(actor, owner, requestType, rollKey, config, suppressNotification = false, groupRollId = null) {
    return RollMenuOrchestrationUtil.sendRollRequestToPlayer(actor, owner, requestType, rollKey, config, suppressNotification, groupRollId);
  }
  ...
  _showConsolidatedNotification(successfulRequests, rollMethodName, rollKey) {
    return RollMenuOrchestrationUtil.showConsolidatedNotification(successfulRequests, rollMethodName, rollKey);
  }
  ...
  async _handleGMRolls(actors, requestType, rollKey, rollProcessConfig) {
    return RollMenuExecutionUtil.handleGMRolls(actors, requestType, rollKey, rollProcessConfig);
  }
  ...
  async _handleGMRollsWithTokens(actorEntries, requestType, rollKey, rollProcessConfig) {
    return RollMenuExecutionUtil.handleGMRollsWithTokens(actorEntries, requestType, rollKey, rollProcessConfig);
  }
  ...
  async _initiateRollForToken(actor, token, requestType, rollKey, rollProcessConfig) {
    return RollMenuExecutionUtil.initiateRollForToken(actor, token, requestType, rollKey, rollProcessConfig);
  }
  ...
  async _initiateRoll(actor, requestType, rollKey, rollProcessConfig) {
    return RollMenuExecutionUtil.initiateRoll(actor, requestType, rollKey, rollProcessConfig);
  }
