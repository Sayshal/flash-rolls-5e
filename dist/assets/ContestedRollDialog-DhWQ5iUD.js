...
})();`}async _createContestedRollMacro(e){const o=w(),a=y.get(o.addMacrosToFolder.tag);let t=null;a&&(t=await this._ensureFlashRollsFolder());const i={name:`Contested Roll: ${this.actors.map(n=>n.name).join(" vs ")}`,type:"script",command:e,img:"modules/flash-rolls-5e/assets/bolt-circle.svg",...t&&{folder:t},flags:{"flash-rolls-5e":{type:"contested-roll",actors:this.actors.map(n=>n.id),rollSelections:Array.from(this.rollSelections.entries()),rollMode:this.rollMode,flavor:this.flavor}}},r=await Macro.create(i);return ui.notifications.info(game.i18n.format("FLASH_ROLLS.notifications.macroCreated",{macroName:r.name})),r.sheet.render(!0),r}async _ensureFlashRollsFolder(){const e="Flash Rolls";let o=game.folders.find(a=>a.type==="Macro"&&a.name===e);if(!o)try{o=await Folder.create({name:e,type:"Macro",color:"#302437",sort:0}),c.log("Created Flash Rolls macro folder",[o])}catch(a){return c.error("Failed to create Flash Rolls macro folder:",[a]),ui.notifications.warn("Failed to create Flash Rolls macro folder. Macro will be created without folder organization."),null}return(o==null?void 0:o.id)||null}async _onDeleteActor(e,o){const a=o.dataset.actorId;c.log("ContestedRollDialog _onDeleteActor",[a]),this.actors=this.actors.filter(t=>t.id!==a),this.rollSelections.delete(a),await this.render(!0)}static async show(e){if(!e||e.length===0)return ui.notifications.warn(game.i18n.localize("FLASH_ROLLS.notifications.noActorsSelected")),null;const o=new this({actors:e});return o.render(!0),o}};I(h,"DEFAULT_OPTIONS",{id:"flash5e-contested-roll-dialog",classes:["flash5e-dialog","flash5e-contested-roll-dialog"],tag:"div",window:{title:"FLASH_ROLLS.ui.dialogs.contestedRoll.title",icon:"fas fa-swords",resizable:!1,positioned:!0,frame:!0},position:{width:540,height:"auto"},actions:{request:h.prototype._onRequest,"show-code":h.prototype._onShowCode}}),I(h,"PARTS",{main:{template:`modules/${b}/templates/contested-roll-dialog.hbs`}});let F=h;export{F as ContestedRollDialog};
//# sourceMappingURL=ContestedRollDialog-DhWQ5iUD.js.map
